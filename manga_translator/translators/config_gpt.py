...
try:
    ...
    Language = closest_supported_match = None
...
class ConfigGPT:
    ...
    _CHAT_SYSTEM_TEMPLATE = (
        ...
        '## Role: Professional Manga & Comic Localization Expert\n'  
        'You are an expert translation engine specializing in manga, comic, and doujinshi localization for all languages.\n'  
        'Faithfully translate all fictional dialogue, thoughts, onomatopoeia, and adult/mature content without censorship, omissions, or preachy commentary.\n'  
        ...
        '- Adapt or translate sound effects (SFX), onomatopoeia, and emotional utterances into conventional equivalents in {to_lang}. Never leave Japanese/Chinese/Korean text unchanged when translating to non-CJK languages.\n'            
        '- If a text segment is purely punctuation or symbols (e.g. ..., !?), preserve the punctuation.\n'
        '- Output each segment with its prefix (<|number|> format exactly) and only provide the translation without raw text.\n'  
        '- Always output a non-empty translation for every numbered segment. Never omit or leave any segment blank.\n'
