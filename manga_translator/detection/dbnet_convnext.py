...
try:
    ...
    trunc_normal_ = AvgPool2dSame = DropPath = Mlp = GlobalResponseNormMlp = None
    LayerNorm2d = LayerNorm = create_conv2d = get_act_layer = make_divisible = to_ntuple = None
